...
| 11 | **Production artifacts** — retrain on pooled data, calibrate, bundle | [`backend/scripts/train.py`](../backend/scripts/train.py) | [`README.md`](../README.md) (model artifacts), `models/manifest.json` |
