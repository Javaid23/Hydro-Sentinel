...
Numbers: [xgb_baseline.json](xgb_baseline.json), generated by `backend/scripts/evaluate_xgb.py`
and served by `/validation`; run the script for the same figures as a table. Data: [../data_findings.md](../data_findings.md).
