...
Numbers: [models/xgb_baseline.json](../../models/xgb_baseline.json), generated by
`backend/scripts/evaluate_xgb.py` and served by `/validation`; run the script for the same
figures rendered as a table. Data: [../data_findings.md](../data_findings.md).
