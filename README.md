...
docs/               PIPELINE.md (end-to-end trace), decisions.md (D1–D10), results/
```
...
| [docs/decisions.md](docs/decisions.md) | Every deviation from the spec and why (D1–D10) |
| [docs/data_findings.md](docs/data_findings.md) | What the USGS release actually contains and how it was filtered |
| [docs/results/](docs/results/) | Baseline, benchmarks, uncertainty coverage, data-quality sensitivity — generated by the evaluation scripts |
